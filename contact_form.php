    ...
    if (empty($error_msg) && empty($phone_err)) {
        ...
        if (mysqli_query($con, $query)) {
            ...
            try {
                ...
                $mail->setFrom('balaabimanyugnc@gmail.com', 'Ananya Hospital');
                $mail->addAddress('balaabimanyugnc@gmail.com', 'Ananya Hospital');
                $mail->isHTML(true);
                $mail->Subject = 'New Ananya Hospital Inquiry';
                $mail->Body = $html;
                ...
                $userMail->setFrom('balaabimanyugnc@gmail.com', 'Ananya Hospital');
                ...
                $subject = 'New Ananya Hospital Inquiry';
